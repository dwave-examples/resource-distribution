...
def run_page():   
    ...
    _, middle, __ = st.beta_columns([1,1,1])
    middle.image(os.path.join(root, "assets/partitioning.png"), use_column_width=True)
    ...
    _, middle, __ = st.beta_columns([1,1,1])
    middle.image(os.path.join(root, "assets/partition_with_distance.png"), use_column_width=True)
